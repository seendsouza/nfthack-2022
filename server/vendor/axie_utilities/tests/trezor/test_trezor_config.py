...
def test_trezor_setup_init_existing_config(tmpdir):
    ...
    config_data = {
        "ronin:<account_s1_address>": {"passphrase": "", "bip_path": "m/44'/60'/0'/0/0"}
    }
...
@patch(
    "trezor.trezor_setup.ethereum.get_address",
    return_value="ronin:<account_s1_address>01234567890123456789",
)
