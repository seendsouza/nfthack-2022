...
@patch(
    "trezor.TrezorAxieClaimsManager.load_trezor_config_and_acc_name",
...
def test_has_unclaimed_slp(
    mocked_provider, mocked_checksum, mocked_contract, mocked_parse, mocked_check
):
...
def test_has_unclaimed_slp_failed_req(
    mocked_provider, mocked_checksum, mocked_contract, mocked_parse
):
    with requests_mock.Mocker() as req_mocker:
        req_mocker.get(
            "https://game-api.skymavis.com/game-api/clients/0xfoo/items/1",
