...
@patch(
    "web3.eth.Eth.contract.functions.balanceOf.call", return_value=1000000000000000000
)
@patch("web3.Web3.toChecksumAddress", return_value="checksum")
@patch("web3.eth.Eth.contract")
@patch("web3.Web3.HTTPProvider", return_value="foo")
...
def test_load_json_safeguard():
    ...
    assert str(e.value) == (
        "File path non_existent.json does not exist. " "Please provide a correct one"
    )
