...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {
                "Manager": "ronin:123",
                "Scholars": [{"Name": "foo", "AccountAddress": "ronin:abc"}],
            },
                ...
                "Scholars": [
                    {
                        "Name": "foo",
                        "AccountAddress": "ronin:abc",
                        "ScholarPayoutAddress": "def",
                        "ScholarPayout": 123,
                        "ManagerPayout": 345,
                    }
                ],
            },
            "'def' does not match '^ronin:'",
        ),
        (
            {
                "Manager": "ronin:gha",
                "Scholars": [
                    {
                        ...
                        "ScholarPayout": 123,
                        "ManagerPayout": 345,
                        "TrainerPayoutAddress": "ronin:xyz",
                    }
                ],
            },
        ...
        (
            {
                ...
                "Donations": [{"Name": "foo", "AccountAddress": "ronin:dono"}],
            },
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            [{"AccountAddress": "ronin:abc", "Transfers": [{"AxieId": "abc"}]}],
        ...
        (
            [
                {
                    "AccountAddress": "ronin:abc",
                    "Transfers": [{"AxieId": "abc", "ReceiverAddress": "foo"}],
                }
            ],
        ...
        (
            [
                {
                    "AccountAddress": "ronin:abc",
                    "Transfers": [{"AxieId": 123, "ReceiverAddress": "foo"}],
                }
            ],
    ...
    [
        (
            [
                {
                    "AccountAddress": "ronin:abc",
                    "Transfers": [{"AxieId": 123, "ReceiverAddress": "ronin:foo"}],
                }
            ]
        ),
        (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            [{"AccountAddress": "foo", "Sire": "foo", "Matron": "foo"}],
            "'foo' does not match '^ronin:'",
        ),
        (
            [{"AccountAddress": "ronin:foo", "Sire": "foo", "Matron": "foo"}],
            "'foo' is not of type 'number'",
        ),
        (
            [{"AccountAddress": "ronin:foo", "Sire": 0, "Matron": "foo"}],
            "'foo' is not of type 'number'",
        ),
        (
            [{"AccountAddress": "ronin:foo", "Sire": 0, "Matron": "foo"}],
